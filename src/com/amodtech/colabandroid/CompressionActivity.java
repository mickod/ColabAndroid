...
public class CompressionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
    	Log.d("JNIActivity onCreate","entry");
    	...
    	Log.d("JNIActivity onCreate","Setting default Text");
    	
    	// Retrieve the text from native method getMessage()
    	Log.d("JNIActivity onCreate","Setting Text with native method");
    	Log.d("JNIActivity onCreate","Text from native: " + getMessage());
    	textView.setText(getMessage());
    	setContentView(textView);
    	Log.d("JNIActivity onCreate","Content View set");
    	
    	// Init a video file 
    	int videoInitReturnCode = naInit(Environment.getExternalStorageDirectory() + "/9_Sec_BBBunny_Trailer.mp4");
    	Log.d("JNIActivity onCreate","videoInitReturnCode: " + videoInitReturnCode);
    	...
    	String argv[] = {"ffmpeg", "-i", Environment.getExternalStorageDirectory() + "/BigBuckBunny_320x180.mp4", "-strict", "experimental", "-acodec", "aac", Environment.getExternalStorageDirectory() + "/CompressedBBB_320x180_aac.mp4"};
    	Log.d("JNIActivity onCreate","Calling ffmpegWrapper");
    	int ffmpegWrapperreturnCode = ffmpegWrapper(argv);
    	Log.d("JNIActivity onCreate","ffmpegWrapperreturnCode: " + ffmpegWrapperreturnCode);
   	}
}
